...
ADAPTERS is imported by the comparison statistics downstream
(hydrodynamic-comparison/), so that the comparison sees each host through the
same conventions that drove its runs.
