...
# SENSITIVITY TEST: H_h = 1/3 (the canonical Corrsin-Obukhov/LS value)
# instead of the branch default 0.5. steam.simulate reads the module
# global H_h at call time; steam/__init__ rebinds the name steam.simulate
# to the function, hence importlib for the real module.
import importlib
_steam_simulate_module = importlib.import_module("steam.simulate")
_steam_simulate_module.H_h = 1.0 / 3.0
