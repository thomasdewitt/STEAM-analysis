...
witness "$RUNS/small_c002_s0030.nc" --output "$SPHERO_DIR" --size 1920 700 --group parent --nest-group nest --camera-position 0.82854244016 -0.685508341159 -0.987484355444 --camera-azimuth 59.4 --camera-elevation 22 --fov 100 --sun-azimuth 20 --sun-elevation 55 --periodic --gamma 1.66 --white-point 15 --contrast 1 --haze 1;
witness "$RUNS/small_c002_s0010.nc" --output "$SPHERO_DIR" --size 1920 700 --group parent --nest-group nest --camera-position 0.82854244016 -0.685508341159 -0.987484355444 --camera-azimuth 59.4 --camera-elevation 22 --fov 100 --sun-azimuth 20 --sun-elevation 55 --periodic --gamma 1.66 --white-point 15 --contrast 1 --haze 1;
witness "$RUNS/small_c002_s0100.nc" --output "$SPHERO_DIR" --size 1920 700 --group parent --nest-group nest --camera-position 0.82854244016 -0.685508341159 -0.987484355444 --camera-azimuth 59.4 --camera-elevation 22 --fov 100 --sun-azimuth 20 --sun-elevation 55 --periodic --gamma 1.66 --white-point 15 --contrast 1 --haze 1;
